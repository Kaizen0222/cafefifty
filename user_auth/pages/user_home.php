...
<body>
    ...
    <div class="header">
        <span class="user-info">Welcome! <strong><?php echo $_SESSION['username']; ?></strong></span>
        <a href="/cafe_fifty/user_auth/pages/dashboard.php">View Bookings</a>
        <a href="logout.php" class="book-button" style="background-color: #e63946; margin-top: 10px;">Logout</a>
    </div>
    ...
    <div class="home-container">
        ...
        <a href="/cafe_fifty/user/index.php" class="book-button">Book Now</a>
        <a href="/cafe_fifty/user/calendar.php" class="book-button" style="margin-top: 20px; background-color: #2d5af0;">View Calendar</a>
